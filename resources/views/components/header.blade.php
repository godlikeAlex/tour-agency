...
<header>
        <div class="slide-menu-header slide-menu-header-hide">
            <i class="fas fa-times close-slide"></i>
            <ul>
                <li>Узбекисант</li>
                <li>Новости</li>
                <li>Люди</li>
        ...
        <div class="menu-mobile">
            <ul class="main-menu-m">
                ...
                <li>
                    <a href="category-01.html">Узбекистан</a>
                </li>
                ...
                <li>
                    <a href="category-01.html">Блог</a>
                </li>
            ...
            <div class="main-nav">
                ...
                <nav class="menu-desktop">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide-menu-header-button">
                        ...
                        <li class="mega-menu-item">
                            ...
                            <div class="sub-mega-menu">
                                <div class="nav flex-column nav-pills" role="tablist">
                                    <a class="nav-link active" data-toggle="pill" href="#uz_all" role="tab">Все</a>
                                    <a class="nav-link" data-toggle="pill" href="#politic" role="tab">География</a>
                                    <a class="nav-link" data-toggle="pill" href="#buisnes" role="tab">История</a>
                                    <a class="nav-link" data-toggle="pill" href="#public" role="tab">Люди</a>
                                    <a class="nav-link" data-toggle="pill" href="#tehno" role="tab">Кухня</a>
                                    <a class="nav-link" data-toggle="pill" href="#culture" role="tab">Религия</a>
                                </div>

                                <div class="tab-content">
                                    <div class="tab-pane show active" id="uz_all" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                        ...
                        <li class="mega-menu-item">
                            ...
                            <div class="sub-mega-menu">
                                <div class="nav flex-column nav-pills" role="tablist">
                                    <a class="nav-link active" data-toggle="pill" href="#all_city" role="tab">Все</a>
                                    <a class="nav-link" data-toggle="pill" href="#city_info" role="tab">Общая информация</a>
                                    <a class="nav-link" data-toggle="pill" href="#history_city" role="tab">История</a>
                                    <a class="nav-link" data-toggle="pill" href="#pamyatniki" role="tab">Достопримичатильнсоти</a>
                                    <a class="nav-link" data-toggle="pill" href="#muzei_teatri" role="tab">Музеи и театры</a>
                                    <a class="nav-link" data-toggle="pill" href="#shoping_city" role="tab">Шопинг</a>
                                </div>

                                <div class="tab-content">
                                    <div class="tab-pane show active" id="all_city" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                    ...
                                    <div class="tab-pane" id="city_info" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                    ...
                                    <div class="tab-pane" id="history_city" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                    ...
                                    <div class="tab-pane" id="pamyatniki" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                    ...
                                    <div class="tab-pane" id="muzei_teatri" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                    ...
                                    <div class="tab-pane" id="shoping_city" role="tabpanel">
                                        <div class="row">
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                        ...
                        <li class="mega-menu-item">
                            ...
                            <div class="sub-mega-menu">
                                <div class="nav flex-column nav-pills" role="tablist">
                                    <a class="nav-link active" data-toggle="pill" href="#enter-1" role="tab">Древний мир</a>
                                    <a class="nav-link" data-toggle="pill" href="#enter-2" role="tab">Средние века</a>
                                    <a class="nav-link" data-toggle="pill" href="#enter-3" role="tab">Новое время</a>
                                    <a class="nav-link" data-toggle="pill" href="#enter-4" role="tab">Современость</a>
                                </div>

                                <div class="tab-content">
                                    <div class="tab-pane show active" id="enter-1" role="tabpanel">
                                        <div class="row">
                                            @foreach($header['people']['drevniyMir'] as $drevniyMir)
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                                    <a href="/people/{{$drevniyMir->id}}" class="wrap-pic-w hov1 trans-03">
                                                        <img style="height:120px;" src="/storage/{{$drevniyMir->image}}" alt="IMG">
                                                    </a>
                                    ...
                                    <div class="tab-pane" id="enter-2" role="tabpanel">
                                        <div class="row">
                                            @foreach($header['people']['srednieVeka'] as $srednieVeka)
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                                    <a href="/people/{{$srednieVeka->id}}" class="wrap-pic-w hov1 trans-03">
                                                        <img style="height:120px;" src="/storage/{{$srednieVeka->image}}" alt="IMG">
                                                    </a>
                                    ...
                                    <div class="tab-pane" id="enter-3" role="tabpanel">
                                        <div class="row">
                                            @foreach($header['people']['novoeVremya'] as $novoeVremya)
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                                    <a href="/people/{{$novoeVremya->id}}" class="wrap-pic-w hov1 trans-03">
                                                        <img style="height:120px;" src="/storage/{{$novoeVremya->image}}" alt="IMG">
                                                    </a>
                                    ...
                                    <div class="tab-pane" id="enter-4" role="tabpanel">
                                        <div class="row">
                                            @foreach($header['people']['sovremenost'] as $sovremenost)
                                            <div class="col-3">
                                                <!-- Item post -->
                                                <div>
                                                    <a href="/people/{{$sovremenost->id}}" class="wrap-pic-w hov1 trans-03">
                                                        <img style="height:120px;" src="/storage/{{$sovremenost->image}}" alt="IMG">
                                                    </a>
                        ...
                        <li class="mega-menu-item" style="    display: flex;align-items: center; width: 45%;justify-content: flex-end;">                
        ...
        @elseif($type==='uzbekistan')
        <div style="color:white;background: #007bff;">
            <div class="container">
            <nav class="col-md-12 category_nav" >
                            <div><a href="{{route('uzb.category', ['category' => 'geo'])}}"><i class="fas fa-globe-asia"></i> География</a></div>
                            <div><a href="{{route('uzb.category', ['category' => 'history'])}}"><i class="fas fa-mosque"></i> История</a></div>
                            <div><a href=""><i class="fas fa-users"></i> Люди</a></div>
                            <div class="menu_hov" data-menu-target="tourism" href="">
                                <i class="fas fa-hotel"></i> Туризм  <i style="padding-left:5px" class="fas fa-chevron-down"></i>
                                <div data-menu="tourism" class="sub-menu-header">
                            ...
                            <div class="menu_hov" data-menu-target="iskus" href=""><i class="fas fa-paint-brush"></i> Искуства <i style="padding-left:5px" class="fas fa-chevron-down"></i>
                            ...
                            <div class="menu_hov" data-menu-target="cult" href=""><i class="fas fa-archway"></i> Культура <i style="padding-left:5px" class="fas fa-chevron-down"></i>
        ...
        @endif
        <script>
            const h = document.querySelectorAll('.menu_hov');
            const menus = document.querySelectorAll('div[data-menu]');
            const category_nav = document.querySelector('.category_nav');
            
            category_nav.addEventListener('mouseover', e => {
                if(e.target.tagName !== 'A' &&!e.target.classList.contains('sub-menu-header') && !e.target.classList.contains('menu_hov')) {
            ...
            h.forEach(menu => {
                ...
                if(e.target.tagName === 'DIV') {
                    let targetAttr = e.target.getAttribute('data-menu-target');
                    menus.forEach(element => {
                        let menuAttr = element.getAttribute('data-menu');
                        if(menuAttr == targetAttr) {
                            menus.forEach(element => {
                                element.style.display = 'none';
                            }); 
    ...
    <script>
        window.addEventListener('scroll', e => {
            ...
            const fixedMenu = document.querySelector('.main-nav');
            if(position === 300 || position >= 390) {
                fixedMenu.classList.add('main-nav-hidden');
            }
            if(position <= 300) {
                fixedMenu.classList.remove('main-nav-show');
                fixedMenu.classList.remove('main-nav-hidden');
            }

            if(position >= 400) fixedMenu.classList.add('main-nav-show');;
         });
    </script>
