...
<!-- Feature post -->
<section class="bg0" style="margin-top: 50px;">
    <div class="container">
                    ...
                    <div class="tab01 p-b-20">
                        <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tab1-1" role="tab">Все</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab1-2" role="tab">Древний мир</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab1-3" role="tab">Средние века</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab1-4" role="tab">Новое время</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab1-5" role="tab">Современость</a>
                                </li>
                            ...
                            <!--  -->
                            <a href="/people/" class="tab01-link f1-s-1 cl9 hov-cl10 trans-03">
                                Посмотреть всех
                            ...
                            <div class="tab-pane fade show active" id="tab1-1" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        <!-- Item post -->
                                        <div class="m-b-30">
                                            <a href="people/{{$header['people']['drevniyMir'][0] -> id}}" class="wrap-pic-w hov1 trans-03">
                                                <img style="height:240px;" src="/storage/{{$header['people']['drevniyMir'][0] -> image}}" alt="IMG">
                                            </a>

                                            <div class="p-t-20">
                                                <h5 class="p-b-5">
                                                    <a href="{{$header['people']['drevniyMir'][0] -> id}}" class="f1-m-3 cl2 hov-cl10 trans-03">
                                                        {{$header['people']['drevniyMir'][0] -> name}}
                                                    </a>
                                                </h5>
                                            </div>
                                            <span class="cl8">
                                            @if($header['people']['drevniyMir'][0]->category == 'drevniy-mir')
                                                <a href="/people/category/drevniy-mir" class="f1-s-4 cl8 hov-cl10 trans-03">Древний мир</a>
                                            @elseif($header['people']['drevniyMir'][0]->category == 'srednie-veka')
                                                <a href="/people/category/srednie-veka" class="f1-s-10 cl0 hov-cl10 trans-03 text-uppercase txt-center m-b-33">Средние века</a>
                                            @elseif($header['people']['drevniyMir'][0]->category == 'novoe-vremya')
                                                <a href="/people/category/novoe-vremya" class="f1-s-10 cl0 hov-cl10 trans-03 text-uppercase txt-center m-b-33">Новое время</a>
                                            @else 
                                                <a href="/people/category/sovremenost" class="f1-s-10 cl0 hov-cl10 trans-03 text-uppercase txt-center m-b-33">Современость</a>
                                            @endif
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="/people/{{$header['people']['srednieVeka'][0] -> id}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img style="height:75px" src="/storage/{{$header['people']['srednieVeka'][0] -> image}}" alt="IMG">
                                            </a>

                                            <div class="size-w-2">
                                                <h5 class="p-b-5">
                                                    <a href="/people/{{$header['people']['srednieVeka'][0] -> id}}" class="f1-s-5 cl3 hov-cl10 trans-03">
                                                        {{$header['people']['srednieVeka'][0] -> name}}
                                                    </a>
                                                </h5>
                                                <span class="cl8">
                                                @if($header['people']['srednieVeka'][0]->category == 'drevniy-mir')
                                                    <a href="/people/category/drevniy-mir" class="f1-s-6 cl8 hov-cl10 trans-03">Древний мир</a>
                                                @elseif($header['people']['srednieVeka'][0]->category == 'srednie-veka')
                                                    <a href="/people/category/srednie-veka" class="f1-s-6 cl8 hov-cl10 trans-03">Средние века</a>
                                                @elseif($header['people']['srednieVeka'][0]->category == 'novoe-vremya')
                                                    <a href="/people/category/novoe-vremya" class="f1-s-6 cl8 hov-cl10 trans-03">Новое время</a>
                                                @else 
                                                    <a href="/people/category/sovremenost" class="f1-s-6 cl8 hov-cl10 trans-03">Современость</a>
                                                @endif
													</span>
                                            </div>
                                        </div> 
                    ...
                    <div class="tab01 p-b-20">
                        <div class="tab01-head how2 how2-cl2 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab2-4" role="tab">Small Туры</a>
                                </li>
